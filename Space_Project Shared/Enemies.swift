...
func createFollowingEnemy(scene: SKScene, screenSize: CGSize, playerNode: SKSpriteNode, speedMultiplier: CGFloat, enemyCategory: UInt32, playerCategory: UInt32, playerBulletCategory: UInt32) {
